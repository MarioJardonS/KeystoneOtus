...
community <- paste0( "../data/tables/" , args[2] )
...
if (args[3] == "degrees" || args[3] == "closeness" || args[3] == "betweenness"){
  key_otus <- paste0( "../results/otus_by_centrality/" , args[1] )
...
ggsave(paste0(args[2] , "_" , args[3] , "_correlation.png") , plot = last_plot() , device = "png")
